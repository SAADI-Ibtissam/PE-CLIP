...
DFEW_SOURCE = "./datasets/DFEWdataset"
...
def main():
    ...
    for anno_file in all_anno_file:
        ...
        write_file_path = os.path.join("./datasets/DFEWdataset/Annotation", write_file_path)
        print("ok2")
        ...
        for index, row in data.iterrows():
            ...
            full_video_name = os.path.join("./datasets/DFEWdataset/Clip/clip_224x224", video_name)
